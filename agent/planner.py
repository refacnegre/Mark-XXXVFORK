...
from core.llm_adapter import complete_json
...
def create_plan(goal: str, context: str = "") -> dict:
    ...
    try:
        plan = complete_json(user_input, system_instruction=PLANNER_PROMPT)
...
Create a REVISED plan for the remaining work only. Do not repeat completed steps."""
    ...
    try:
        plan = complete_json(prompt, system_instruction=PLANNER_PROMPT)
